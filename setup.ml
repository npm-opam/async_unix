(* OASIS_START *)
(* DO NOT EDIT (digest: 03f8487c27d8bf37de3a7b0405e3e1f8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_unix";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["dump_core_on_job_delay_stubs.c"];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "tzB\149\029\214\238R\173_\141r\243\191W\016";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
